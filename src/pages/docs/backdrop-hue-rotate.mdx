...
<template preview>
  <div class="grid grid-cols-2 gap-2 sm:grid-cols-5">
    <div class="relative h-16 rounded-md overflow-hidden">
      ...
      <div class="absolute inset-0 rounded-md backdrop-filter -backdrop-hue-rotate-180 flex items-center justify-center overflow-hidden">
        <p class="font-extrabold text-white">-180</p>
      </div>
    </div>
    <div class="relative h-16 rounded-md overflow-hidden">
      <div aria-hidden="true" class="absolute inset-0 bg-center bg-cover" style="background-image:url('https://images.unsplash.com/photo-1608501821300-4f99e58bba77?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=256&q=80&duotone=3730A3,4338CA&duotone-alpha=50');"></div>
      <div class="absolute inset-0 rounded-md backdrop-filter -backdrop-hue-rotate-60 flex items-center justify-center overflow-hidden">
        <p class="font-extrabold text-white">-60</p>
      </div>
    </div>
    <div class="relative h-16 rounded-md overflow-hidden">
      <div aria-hidden="true" class="absolute inset-0 bg-center bg-cover" style="background-image:url('https://images.unsplash.com/photo-1608501821300-4f99e58bba77?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=256&q=80&duotone=3730A3,4338CA&duotone-alpha=50');"></div>
      <div class="absolute inset-0 rounded-md backdrop-filter backdrop-hue-rotate-0 flex items-center justify-center overflow-hidden">
