...
Resize an element's content to fit within its container while maintaining aspect ratio using `.object-contain`.

```html rose
<template preview>
<div class="flex space-x-2">
  <div class="bg-rose-300 bg-stripes bg-stripes-white rounded-md w-1/5">
    <img class="h-48 object-contain" src="/img/placeholder-rose.svg" alt="">
  </div>
  <div class="bg-rose-300 bg-stripes bg-stripes-white rounded-md w-4/5">
    <img class="h-48 mx-auto object-contain" src="/img/placeholder-rose.svg" alt="">
  </div>
</div>
</template>
...
Resize an element's content to fill its container while maintaining aspect ratio using `.object-cover`.
